components/NotificationsSwitch/NotifiIconLight.tsx
==================================================
...
.. code-block:: tsx
    ...
    const NotifiIconLight = ({ height, width }) => {
  return (
    <svg
      width={width}
      height={height}
    ...
    >
      ...
      <path
        ...
        fill="url(#paint0_linear_2143_21891)"
      />
      <defs>
        <linearGradient
          id="paint0_linear_2143_21891"
          x1="393.304"
          y1="91.1319"
          x2="330.824"
          y2="211.026"
...
export default NotifiIconLight
