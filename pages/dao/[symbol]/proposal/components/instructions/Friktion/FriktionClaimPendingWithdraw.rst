pages/dao/[symbol]/proposal/components/instructions/Friktion/FriktionClaimPendingWithdraw.tsx
=============================================================================================
...
import { getFriktionClaimPendingWithdrawSchema } from '@utils/validations'
...
const FriktionClaimPendingWithdraw = ({
  ...
  async function getInstruction(): Promise<UiInstruction> {
    return getFriktionClaimPendingWithdrawInstruction({
      schema,
      form,
      programId,
      connection,
  ...
  const schema = getFriktionClaimPendingWithdrawSchema()
...
export default FriktionClaimPendingWithdraw
